...
alert("Você deve estar logado para adicionar um favorito");
 ...
 $.ajax({
    type:"GET",
    url:"http://app.masterhub.com.br/mobileapp/api/AddFavorito?client_token="+getStorage("client_token")+"&merchant_id="+getStorage('merchant_id')+"",
...
$.ajax({
    type:"GET",
    url:"http://app.masterhub.com.br/mobileapp/api/VerificaFavorito?client_token="+getStorage("client_token")+"&merchant_id="+getStorage('merchant_id')+"",
	data: { get_param: 'icone' }, 
	dataType: 'jsonp',
    success: function(data) {
		var dados = JSON.stringify(data);
